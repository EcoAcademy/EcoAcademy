...
// Define the prop types for the TwoStoryHouse component
interface TwoStoryHouseProps {
  onDrop: (itemId: string, position: [number, number, number]) => void;
  droppedItems: DroppedItem[];
}

const TwoStoryHouse = ({ onDrop, droppedItems }: TwoStoryHouseProps) => {
  // Create refs
