        ...
        <>
            ...
            <div className="min-h-screen bg-gray-100 p-8">
                <div className="bg-white p-8 rounded-lg shadow-lg max-w-3xl mx-auto">
                    ...
                    <p className="text-gray-700 mb-4">
                        These Terms shall be governed by and construed in accordance with the laws of NSW, Australia, without regard to its conflict of law principles. Any disputes arising from these Terms or your use of the Site shall be resolved in the courts of NSW, Australia.
                    </p>
                    ...
                    <p className="text-gray-700 mb-4">Email: ecoacademy@archanaut.com</p>
